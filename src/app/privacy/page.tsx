    ...
    <div className="py-20">
      <div className="section-container max-w-3xl">
        ...
        <div className="prose-content">
          ...
          <p>We also use Vercel Web Analytics, a cookieless, privacy-focused analytics service that does not use cookies or collect personally identifiable information, and is not currently gated behind the consent banner above (it operates independently of cookie-based consent because it sets no cookies).</p>
