...
const ROADMAP_STAGES = [
  {
    ...
    desc: 'No license, no entity, no systems. The roadmap walks you through every foundation step — in order, with the exact tools and links to complete each one.',
  ...
  },
  {
    ...
    desc: 'The roadmap evolves with you — benchmarking your KPIs against top performers in your trade, building leadership, and making your business valuable enough to sell.',
...
export default function HomePage() {
  return (
    <main className="min-h-dvh flex flex-col bg-brand-navy overflow-x-hidden">
      ...
      <section className="relative grid-lines min-h-dvh flex flex-col justify-center px-5 pt-28 pb-20">
        ...
        <div className="relative z-10 max-w-md mx-auto w-full">
          ...
          <div className="flex items-center justify-center gap-2.5 mb-5"
            ...
            <span className="font-mono text-[10px] tracking-[0.25em] uppercase text-brand-silver">MetrixScore™ Assessment</span>
          </div>
          ...
          <p className="text-brand-silver leading-relaxed mb-8 text-[15px] text-center"
            ...
            Whether you&apos;re thinking about starting, already running, or ready to grow —
            the MetrixScore™ tells you exactly where your business stands and gives you
      ...
      {/* ══════════════════════════════════════════════
          SECTION 1 — THE PERSONAL ROADMAP (HERO FEATURE)
          This is the big sell — make it impossible to miss
      ══════════════════════════════════════════════ */}
        ...
        <div className="max-w-md mx-auto">
          <Reveal>
            ...
            <h2 className="font-display text-brand-white leading-none mb-4"
              ...
              FROM FIRST IDEA TO SUPERHEATED BUSINESS — WE WALK WITH YOU.
            </h2>
            <Rule />
            ...
            <p className="text-brand-silver text-[16px] leading-relaxed mb-8">
              Whether you haven&apos;t started yet or you&apos;re already running a crew —
          ...
          <Reveal delay={320}>
            <div className="rounded-sm p-6 text-center"
              ...
              <p className="text-brand-silver text-[14px] leading-relaxed mb-5">
                ...
                Your roadmap updates. The guidance gets deeper as your business gets stronger —
              ...
              <Link href="/assessment"
                ...
                Get My Personal Roadmap — Free <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
          </Reveal>
        </div>
        ...
        <div className="max-w-md mx-auto">
          <Reveal>
            ...
            <p className="text-brand-silver text-[15px] leading-relaxed mb-5">
              They freeze from a slow accumulation of small gaps — pricing that doesn&apos;t cover real costs,
            ...
            <p className="text-brand-silver text-[15px] leading-relaxed">
              The problem isn&apos;t effort. It&apos;s operating without a temperature reading — without knowing
          ...
          <Reveal delay={120}>
            <div className="mt-8 space-y-3">
              {[
                ...
                'Never formalized the legal and financial foundation — and paid for it',
              ].map((item) => (
          ...
          <div className="space-y-4 mt-2">
            {[
              ...
              },
              {
                ...
                desc: 'Your MetrixScore™ is calculated instantly across six areas. You see your band — Sub-Zero, Cold, Warm, Hot, or Superheated — and exactly which areas are holding you back.',
              },
              {
                num: '03', icon: Map, color: '#1D9E75',
                title: 'Unlock your personal roadmap',
                desc: 'Your roadmap is built specifically for your trade, your stage, and your gaps — with prioritized action steps, curated tools, and guidance that walks with you from day one to scale.',
              },
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              { icon: Map,          color: '#EF9F27', title: 'Your personal roadmap',       desc: 'Step-by-step priorities built for your trade and stage — not generic advice. What to do first, second, and next.' },
              ...
              { icon: FileText,     color: '#1D9E75', title: 'Curated resource links',      desc: 'Tools and partners matched to your exact gaps — finance, insurance, software, marketing. Only what you actually need.' },
          ...
          <Reveal delay={360}>
            <Link href="/assessment"
              ...
              Start My MetrixScore™ — Free <ArrowRight className="w-4 h-4" />
            </Link>
          </Reveal>
        </div>
      </section>
        ...
        <div className="max-w-md mx-auto">
          <Reveal>
            ...
            <p className="text-brand-silver text-[15px] leading-relaxed mb-6">
              ...
              As your MetrixScore™ rises, your trade-specific experience unlocks —
        ...
        <div className="max-w-md mx-auto">
          <Reveal>
            ...
            <p className="text-brand-silver text-[15px] leading-relaxed mb-5">
              ...
              field operations, and technician leadership — including time managing crews, handling
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="mb-6 p-4 rounded-sm steel-border" style={{ background: 'rgba(13,43,92,0.2)' }}>
            ...
            <p className="text-[12px] text-brand-silver/70 leading-relaxed">
              ...
              do not influence MetrixScore™ results or roadmap recommendations.
            </p>
          ...
          <p className="text-[11px] text-brand-silver/40 leading-relaxed">
            © {new Date().getFullYear()} SubZeroMetrix · The Modern Trades Mentor<br />
