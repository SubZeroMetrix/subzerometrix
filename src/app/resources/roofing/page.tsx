    ...
    <div className="py-20">
      ...
      <div className="section-container max-w-3xl">
        ...
        <div className="prose-content">
          ...
          <p>
            Modern Trades CRM surfaces aging estimates, overdue follow-ups, and customers who&apos;ve gone
            quiet. It gives each of these a visible owner and a next action.
          </p>

          <h2>Where It Does Not Replace Professional Judgment</h2>
          <p>
            Modern Trades CRM doesn&apos;t evaluate roof condition, materials, or code compliance, and it
