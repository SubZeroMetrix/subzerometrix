...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = [
    ...
    '/revenue-leak-check',
    '/modern-trades-crm',
    '/pinellas-contractor-revenue-recovery',
    '/about',
  ...
  return staticRoutes.map((route) => ({
    ...
    priority: route === '' ? 1 : ['/revenue-leak-check', '/modern-trades-crm', '/pinellas-contractor-revenue-recovery'].includes(route) ? 0.9 : route.startsWith('/resources') ? 0.8 : 0.5,
  }))
}
