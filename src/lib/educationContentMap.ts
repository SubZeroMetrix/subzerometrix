...
const EDUCATION_ASSETS_BASE: EducationAssetCore[] = [
  ...
  },
  {
    ...
    tierAccess: 'pro_roadmap', buildStatus: 'built', sourceLocation: 'src/lib/tier2Tools.ts (service_agreement_checklist)',
    relatedFeatureKey: 'core_templates', recommendedStage: 'early', scoreRelated: true, supportsProgressiveScore: true,
  ...
  },
  {
    ...
    tierAccess: 'pro_roadmap', buildStatus: 'built', sourceLocation: 'src/lib/tier2Tools.ts (sales_call_script)',
  ...
  },
  {
    ...
    tierAccess: 'pro_roadmap', buildStatus: 'built', sourceLocation: 'src/lib/tier2Tools.ts (review_request_script)',
    relatedFeatureKey: 'core_templates', recommendedStage: 'any', scoreRelated: true, supportsProgressiveScore: true,
  ...
  },
  {
    ...
    tierAccess: 'pro_roadmap', buildStatus: 'built', sourceLocation: 'src/lib/tier2Tools.ts (financing_conversation_script)',
  ...
  },
  {
    ...
    tierAccess: 'pro_roadmap', buildStatus: 'built', sourceLocation: 'src/lib/tier2Tools.ts (vendor_setup_tracker)',
    relatedFeatureKey: 'core_templates', recommendedStage: 'growth', scoreRelated: false, supportsProgressiveScore: false,
